  ...
  return (
    <div className="bg-white shadow-card fixed bottom-0 right-0 z-30 w-full lg:hidden">
      <ul className="container max-sm:!px-0 flex">
        ...
        <li className="w-1/5">
          <Link href="/categories" className="w-full flex flex-col items-center justify-center text-xs h-[60px]">
            <i className="icon-burger-menu text-md mb-1.5"></i>
            categories
          </Link>
        </li>
        <li className="w-1/5">
          <Link href="/basket" className="w-full flex flex-col items-center justify-center text-xs h-[60px]">
        ...
        <li className="w-1/5">
          <Link href="/shop" className="w-full flex flex-col items-center justify-center text-xs h-[60px]">
            <i className="icon-bag text-md mb-1.5"></i>
            shop
          </Link>
        </li>
        <li className="w-1/5">
          <Link href="/user" className="w-full flex flex-col items-center justify-center text-xs h-[60px]">

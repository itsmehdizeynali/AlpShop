...
export default function Checkbox({name,className,...props}:CheckboxPropsType) {
  ...
  return (
    ...
    >
      ...
      >
         <i className={clsx(isActive?"scale-90":"scale-0","icon-check leading-none transition-all text-white text-xxs")}></i>
      </div>
